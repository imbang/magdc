...
COMMANDS = {
            'list': ('list', 'Displays last 10 days uploaded data'),
##            'get': ('get <remote filename>', 'Downloads a file with a given filename'),
            ...
            'user': ('user <username>', 'Please provide username'),
            'pass': ('pass <password>', 'Please provide password'),
            'auth': ('auth <authentification>','Please provide auth'),
            'sta': ('sta <sta_id>','Provide station id'),
}
